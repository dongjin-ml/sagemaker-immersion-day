...
class lambda_handler():
    ...
    def add_permission(self, strLambdaArn, strLambdaFuncName, SourceArn):
        
        add_lambda_permission = self.client.add_permission(
            FunctionName=strLambdaArn,
            StatementId=str(time.time())[-5:]+strLambdaFuncName,
            Action='lambda:InvokeFunction',
            Principal='events.amazonaws.com',
            SourceArn=SourceArn
        )
        
        return add_lambda_permission
